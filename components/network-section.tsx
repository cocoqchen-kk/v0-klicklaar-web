        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              ...
              {/* Decorative circles */}
              <div className="absolute top-0 left-8 w-20 h-20 primary rounded-full -translate-y-1/2 md:w-24 md:h-24 lg:w-28 lg:h-28"></div>
              ...
              <div className="absolute bottom-0 right-32 w-32 h-32 primary rounded-full translate-y-1/2 md:w-40 md:h-40 lg:w-48 lg:h-48"></div>
              ...
              <div className="absolute bottom-32 right-8 w-20 h-20 bg-white rounded-2xl shadow-lg flex items-center justify-center">
                <div className="w-10 h-10 primary rounded-xl"></div>
              </div>
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <div className="pt-4">
              <button className="primary text-white px-8 py-4 rounded-lg font-semibold text-base sm:text-lg hover:bg-[#4A5FDC] transition-colors shadow-md w-full sm:w-auto">
